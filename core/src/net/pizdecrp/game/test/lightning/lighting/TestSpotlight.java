package net.pizdecrp.game.test.lightning.lighting;
...
import net.pizdecrp.game.test.lightning.lighting.ShadowMap.ShadowMapRenderer;
import net.pizdecrp.game.test.lightning.lighting.utils.Application;

public class TestSpotlight extends ApplicationAdapter implements ShadowMapRenderer {
	...
	private void setupShadowMap() {
		shadowMap = new ShadowMap(SHADOW_MAP_SIZE);
	...
	private void setup() {
		light = new SpotLight(90, SHADOW_MAP_SIZE);
